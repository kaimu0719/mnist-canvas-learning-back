...
ActiveRecord::Schema[8.0].define(version: 2025_09_20_065700) do
  ...
  create_table "prediction_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["drawing_id"], name: "index_prediction_logs_on_drawing_id"
  end
  ...
  add_foreign_key "prediction_logs", "drawings"
